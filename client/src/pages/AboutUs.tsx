...
import aboutUs2 from "../assets/about-us/about-us-2.png";
import aboutUs3 from "../assets/about-us/about-us-3.png";
  ...
  return (
    <div className="about-us-page">
      ...
      <div className="about-us-container">
        <section className="about-us-section pale-text">
          <p>
            ...
            numquam? Cumque inventore, enim rem quae illum nesciunt voluptates facilis praesentium pariatur. Atque qui
            odio nesciunt sunt nulla fuga eligendi in, ut eos exercitationem a. Eligendi tempore deserunt modi placeat,
            atque corporis aperiam, maiores dolor sunt quaerat quasi? Voluptatibus accusantium delectus sed et
        ...
        <div className="about-us-images-wrapper">
          ...
          <img src={aboutUs3} alt="Man1" className="img3" />
        </div>
      </div>
    </div>
  );

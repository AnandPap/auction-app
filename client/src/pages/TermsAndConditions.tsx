    ...
    <div className="terms-and-conditions-page">
      ...
      <section className="terms-and-conditions-section">
        ...
        <p>
          ...
          nesciunt sunt nulla fuga eligendi in, ut eos exercitationem a. Eligendi tempore deserunt modi placeat, atque
          corporis aperiam, maiores dolor sunt quaerat quasi? Voluptatibus accusantium delectus sed et consequatur
          commodi dolore quibusdam vitae quia magni quaerat sapiente cupiditate ipsum ex, mollitia, rerum sunt impedit
          quod! Possimus qui recusandae velit magni eveniet blanditiis ipsam ut animi quae! Quibusdam.
        </p>
      </section>
      <section className="terms-and-conditions-section">
        <h2 className="terms-and-conditions-subtitle">Some title</h2>
